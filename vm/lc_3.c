...
int main(void) {
    ...
    uint16_t baser, cond, flgs, imm5,
	instr, offset6, op, pcoffset9,
	pcoffset11, pmode, run, sr, sr1, sr2,
	trapvect8;
    ...
    while (run) {
		...
		exit(1);
    	    ...
    	    break;
    	default:
    	    fprintf(stderr, "illegal opcode exception: %x\n", op);
    	    exit(1);
    	}
    }
